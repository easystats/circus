...
You can use it in your `testthat` block by directly calling the models However, for it to work on **travis**, it is easier to directly downloading them from github:
