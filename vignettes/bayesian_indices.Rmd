...
compute_indices <- function(models){
  ...
  prior_used <- bayestestR::describe_prior(models$bayesian)[2, ]
...
# Combine
generate_and_process <- function(true_effect, outcome_type, sample_size, error, chains=4, iter=2000, warmup = 1/2){
