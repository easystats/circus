...
You could use the package in your `testthat` block by directly calling the models. However, the usual workflow is to directly download them from github with the `download_model()` function in the [`insight`](https://github.com/easystats/insight) package:
